...
### For Meter Pro Subscribers:
    * The processing fee is 2.9% of the total trip value, plus an additional $0.30 (USD).
### For Non-Subscribers:
    * The processing fee is 4.9% of the total trip value, plus an additional $0.30 (USD).
