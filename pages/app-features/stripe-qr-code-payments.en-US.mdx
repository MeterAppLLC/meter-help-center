...
## Fees
If you are subscribed to Meter Pro, the fees for a transaction are 1% + Stripe processing fees that are listed here depending on payment method: https://stripe.com/pricing/local-payment-methods. If you are not subscribed to Meter Pro, the fees are 5% + Stripe processing fees.
...
1. Sign in to your Meter account on the android app
    ...
    * Click "Sign in"
    * Enter your email and Sign in Code
